...
class Registration extends \Swift_Message
{
    ...
    {
        $html = '<p>Olá {{user_name}},</p><p>Recebemos sua inscrição para o {{event_name}}. A inscrição só é válida após a confirmação da instituição financeira.</p><p>Atenciosamente,<br />Coordenação PHPSC.</p>';
